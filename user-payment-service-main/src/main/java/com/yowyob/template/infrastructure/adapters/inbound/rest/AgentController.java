...
public class AgentController {
    ...
    /**
     * Crée un compte agent (mot de passe haché côté service). Réponse sans mot de passe.
     *
    ...
    /**
     * Publie une demande de recharge sur le bus (nécessite un JWT agent sur la requête).
     *
