...
/**
 * Sécurité WebFlux : JWT dans {@link com.yowyob.template.infrastructure.security.SecurityContextRepository},
 * login par {@link com.yowyob.template.infrastructure.security.AuthenticationManager}.
 */
@Configuration
...
public class SecurityConfig {
    ...
    /**
     * Autorise Swagger et l’authentification publique ; le reste nécessite un Bearer valide.
     *
    ...
    /**
     * @return règles CORS pour les origines front configurées
     */
    @Bean
